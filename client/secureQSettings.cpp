...
SecureQSettings::SecureQSettings(const QString &organization, const QString &application, QObject *parent, bool enableEncryption)
    : QObject { parent }, m_settings(organization, application, parent), encryptedKeys({ "Servers/serversList", "Sharing/accountGroups" }), m_encryptionEnabled(enableEncryption)
{
